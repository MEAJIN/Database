...
namespace hyejin_DB
{
    public partial class 주문조회취소 : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                else if (dataGridView1.SelectedRows[0].Cells[3].Value.ToString().Equals("판매완료"))
                {
                    button3.Hide();
                    button2.Hide();
                    button1.Show();
                ...
                else if (dataGridView1.SelectedRows[0].Cells[3].Value.ToString().Equals("신청"))
                {
                    button3.Hide();
                    button2.Show();
                    button1.Hide();
